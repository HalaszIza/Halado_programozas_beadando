...
def kerdesek13_ablak():
    ...
    def kov_blokkbox():
        ...
        ctk.CTkLabel(box, text="Eddig 3/7, csak így tovább. A következő 2 kérdés a há.", font=("Arial", 12)).pack(pady=20)
        ctk.CTkButton(box, text="Következő kérdések.", command=lambda: (box.destroy(), kerdesek67_ablak())).pack(side=tk.RIGHT,padx=20)
...
def kerdesek67_ablak():
    ...
    def show_msgbox():
        ...
        ctk.CTkButton(box, text="Új játék", command=lambda: (box.destroy())).pack(side=tk.LEFT, padx=20)
